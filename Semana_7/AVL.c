...
/*    refer�ncia encontra-se no documento "Algoritmos para organiza��o da     */
/*    informa��o" de 1962.                                                    */
/******************************************************************************/
...
/* Rota��es � direita (LL e LR)
   Retornar� o endere�o do n� que ser� a nova raiz da sub�rvore originalmente
   iniciada por p */
...
/* Inser��o AVL: p � inicializado com o endereco do n� raiz e
   *alterou com false                                         */
